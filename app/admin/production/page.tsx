        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-10'>
          <div className='lg:col-span-1 flex flex-col gap-6'>
            <div className='bg-ruah-950 text-white p-10 rounded-[3rem] shadow-2xl'>
              <div className='flex flex-col gap-8'>
                <div className='flex flex-col gap-2'>
                  <span className='text-[10px] font-bold text-accent-gold uppercase tracking-[0.2em]'>Capacidade Atual</span>
            ...
            <div className='bg-white border border-ruah-50 p-8 rounded-[2.5rem] flex flex-col gap-3 shadow-sm'>
              ...
              <div className='flex items-center gap-4 p-5 bg-red-50 rounded-2xl border border-red-100'>
                ...
                <span className='text-[9px] font-black text-red-700 uppercase tracking-widest'>{issues} Jobs com problema</span>
              </div>
              <div className='flex items-center gap-4 p-5 bg-green-50 rounded-2xl border border-green-100'>
                <CheckCircle2 size={18} className='text-green-600' />
                <span className='text-[9px] font-black text-green-700 uppercase tracking-widest'>{queued} Jobs aguardando fila</span>
              </div>
            </div>
          </div>
          ...
          <div className='lg:col-span-2 flex flex-col gap-6'>
            <div className='flex justify-between items-center px-4'>
              <h3 className='text-[10px] font-black uppercase tracking-[0.4em] text-ruah-300'>Fulfillment Ativo</h3>
              <span className='text-[8px] font-black text-accent-gold uppercase tracking-widest bg-accent-gold/10 px-2 py-1 rounded'>Dados Reais</span>
            </div>
                    ...
                    <div className='flex flex-col md:flex-row justify-between gap-8'>
                      <div className='flex gap-6'>
                        ...
                        <div className='flex flex-col justify-center gap-1'>
                          <span className='text-[9px] font-black text-accent-gold uppercase tracking-[0.2em]'>{job.productionJobId}</span>
                          <h4 className='text-2xl font-serif uppercase italic font-black leading-tight text-ruah-950'>{job.orderId}</h4>
                          <p className='text-[10px] font-bold text-ruah-400 uppercase tracking-widest'>{STATUS_LABEL[job.status]}</p>
                        </div>
                      </div>
                      <div className='text-right'>
                        <span className='text-[8px] font-bold text-ruah-300 uppercase block mb-1'>Atualizado</span>
