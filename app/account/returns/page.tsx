  ...
  return (
    <div className="flex flex-col gap-12">
      <div>
        ...
        <p className="text-sm font-medium text-lumina-500 mt-4">Processo simplificado e logística reversa sem fricção.</p>
      </div>
        ...
        <div className="lg:col-span-7">
          <div className="bg-white border border-lumina-100 rounded-[2.5rem] p-10 md:p-16">
            <div className="flex items-center gap-6 mb-12">
              ...
              <div>
                <span className="text-xs font-semibold text-accent-blue uppercase tracking-[0.14em] block mb-1">Passo {step} de 3</span>
            ...
            <div className="flex flex-col gap-8">
              <div className="flex flex-col gap-4">
                <span className="text-xs font-semibold text-lumina-400 uppercase tracking-[0.12em]">Selecione o pedido</span>
                <div className="p-6 border border-accent-blue rounded-2xl flex justify-between items-center bg-accent-blue/5">
                  <div className="flex flex-col gap-1">
                    ...
                    <span className="text-xs font-semibold text-accent-blue italic">Disponível para troca até 10 nov</span>
                  </div>
              ...
              <button className="w-full bg-lumina-950 text-white py-6 rounded-2xl font-bold uppercase text-xs tracking-[0.12em] hover:bg-accent-blue transition-all flex items-center justify-center gap-3">
            ...
            <div className="flex flex-col gap-4">
              {RETURN_HISTORY.map((rtn) => (
                <div key={rtn.id} className="bg-white p-6 rounded-2xl border border-lumina-100 flex justify-between items-center">
                  <div className="flex flex-col gap-1">
                    <span className="text-xs font-semibold text-lumina-400 uppercase tracking-[0.1em]">{rtn.date}</span>
            ...
            <ul className="flex flex-col gap-4">
              {[
                ...
                <li key={i} className="flex gap-4 items-start">
                  ...
                  <span className="text-sm font-medium text-lumina-500">{rule}</span>
                </li>
              ))}
            </ul>
          </div>
