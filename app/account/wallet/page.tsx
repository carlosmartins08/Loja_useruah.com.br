  ...
  return (
    <div className="flex flex-col gap-12">
      <div>
        ...
        <p className="text-sm font-medium text-lumina-500 mt-4">Gerencie seus créditos, reembolsos e métodos de pagamento salvos.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-12 bg-lumina-950 rounded-[3rem] p-12 text-white relative overflow-hidden group">
          ...
          <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-12">
            <div>
              <span className="text-accent-blue text-xs font-semibold uppercase tracking-[0.14em] mb-4 block">SALDO DISPONÍVEL</span>
            ...
            <div className="flex flex-col gap-4 w-full md:w-auto">
              <button className="bg-white text-lumina-950 px-10 py-5 rounded-2xl font-bold uppercase text-xs tracking-[0.12em] flex items-center justify-center gap-3 hover:bg-accent-blue hover:text-white transition-all">
            ...
            {TRANSACTIONS.map((t) => (
              <div key={t.id} className="bg-white border border-lumina-100 rounded-3xl p-8 flex justify-between items-center hover:bg-lumina-50 transition-all">
                <div className="flex flex-col gap-1">
                  <span className="text-xs font-semibold text-lumina-400">{t.date}</span>
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              <div className="p-6 bg-white rounded-2xl border border-lumina-200 flex flex-col gap-4 relative group">
                <span className="text-xs font-semibold text-accent-blue uppercase block">Principal</span>
              ...
              <button className="w-full py-4 border-2 border-dashed border-lumina-200 rounded-2xl text-xs font-semibold uppercase tracking-[0.1em] text-lumina-400 hover:border-accent-blue hover:text-accent-blue transition-all">
                + Novo cartão
              </button>
            </div>
          </div>
