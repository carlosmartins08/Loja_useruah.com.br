  ...
  return (
    <div className="flex flex-col gap-12">
      <div>
         ...
         <p className="text-[10px] font-bold text-lumina-400 uppercase tracking-widest mt-4">Sua curadoria pessoal Lumina. Itens prontos para seu próximo projeto.</p>
      </div>
            ...
            <div key={item.id} className="group flex flex-col gap-6">
               <div className="relative aspect-[3/4] rounded-[2.5rem] overflow-hidden bg-lumina-50 border border-lumina-100 group-hover:shadow-2xl transition-all duration-700">
                  ...
                  <div className="absolute bottom-6 left-6">
                     <span className={`px-4 py-2 bg-white/90 backdrop-blur-md rounded-full text-[8px] font-bold uppercase tracking-widest ${item.stock.includes('restam') ? 'text-red-500' : 'text-green-600'}`}>
                        {item.stock}
                     </span>
                  </div>
               </div>
               ...
               <div className="flex flex-col gap-4">
                  ...
                  <button className="w-full bg-lumina-950 text-white py-5 rounded-2xl font-bold uppercase text-[9px] tracking-widest flex items-center justify-center gap-3 hover:bg-accent-blue transition-all active:scale-95">
