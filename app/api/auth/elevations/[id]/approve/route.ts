...
import { approvePrivilegeElevation } from '@/lib/privilege-elevation-store';
...
export async function POST(request: Request, context: { params: Promise<{ id: string }> }) {
  ...
  const result = approvePrivilegeElevation(id, { actorId: actor.actorId });
  ...
  appendAuditLog({
    ...
    action: 'privilege_elevation.approved',
