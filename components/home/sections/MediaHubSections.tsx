      ...
      <section className="bg-ruah-50 section-space border-y border-ruah-100">
        <div className="section-container">
          <div className="flex flex-col items-center text-center mb-16">
            ...
            <h2 className="text-4xl font-serif lowercase italic tracking-tighter font-black uppercase text-ruah-950">Ruah no cotidiano.</h2>
            <p className="text-[10px] font-bold text-ruah-400 uppercase tracking-widest mt-6">Use #GeraçãoRuah e faça parte da nossa história.</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-4 flex flex-col gap-10">
              <div className="flex flex-col gap-4">
                ...
                <h3 className="text-5xl lg:text-7xl font-serif italic font-black uppercase tracking-tighter text-ruah-950 leading-none">
                  Respiro <br /> Criativo.
                </h3>
              </div>

              <p className="text-[12px] font-bold text-ruah-400 uppercase tracking-widest leading-loose max-w-sm">
              ...
              <Link href="https://youtube.com" target="_blank" className="flex items-center gap-6 group self-start">
                ...
                <span className="text-[10px] font-bold uppercase tracking-[0.3em] group-hover:text-red-600 transition-colors">Ver Canal Youtube</span>
              </Link>
            </div>
            ...
            <div className="lg:col-span-8 relative aspect-video rounded-[3rem] overflow-hidden group shadow-2xl bg-ruah-950">
              ...
              <div className="absolute top-10 left-10">
                <span className="bg-red-600 text-white px-4 py-1.5 rounded-full text-[9px] font-bold uppercase tracking-widest">Destaque</span>
              </div>
              <div className="absolute bottom-10 left-10 right-10">
                <h4 className="text-white text-2xl font-serif italic font-black uppercase tracking-tighter mb-2">A Origem do Traço de Lucas S.</h4>
                <p className="text-white/60 text-[9px] font-bold uppercase tracking-widest">Documentário Curto • 04:20</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                ...
                <div className="flex flex-col gap-10">
                  <div className="flex items-center gap-6">
                    ...
                    <div className="flex flex-col gap-2">
                      <span className="text-[14px] font-serif italic font-black text-ruah-950 uppercase tracking-tighter">Sopro da Manh? Vol. 1</span>
                      <span className="text-[9px] font-bold text-accent-gold uppercase tracking-[0.3em]">Curadoria Oficial Ruah</span>
                      <div className="flex items-center gap-2 mt-2">
                        <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse" />
                        <span className="text-[8px] font-bold text-ruah-200 uppercase tracking-widest">Tocando Agora</span>
                      </div>
                    </div>
                  </div>
                    ...
                    {TRACKS.map((track, i) => (
                      <div key={i} className="flex items-center justify-between p-4 rounded-2xl hover:bg-ruah-50 transition-colors group/track cursor-pointer border border-transparent hover:border-ruah-100">
                        <div className="flex items-center gap-5">
                          <span className="text-[10px] font-serif italic text-ruah-200 group-hover/track:text-accent-gold font-black">0{i + 1}</span>
                          <div className="flex flex-col">
                            <span className="text-[11px] font-bold text-ruah-950 uppercase">{track.title}</span>
                            <span className="text-[8px] font-bold text-ruah-200 uppercase tracking-widest">{track.artist}</span>
                          </div>
                        </div>
                        <div className="flex items-center gap-4">
                          <span className="text-[8px] font-serif italic text-ruah-200">{track.time}</span>
                  ...
                  <Link href="https://spotify.com" target="_blank" className="w-full bg-ruah-950 text-white p-6 rounded-2xl flex items-center justify-center gap-4 text-[10px] font-bold uppercase tracking-[0.3em] hover:bg-green-500 transition-all shadow-2xl">
            ...
            <div className="flex flex-col gap-10 order-1 lg:order-2">
              <div className="flex flex-col gap-4">
                ...
                <h2 className="text-5xl lg:text-7xl font-serif italic font-black uppercase tracking-tighter text-ruah-950 leading-none">
              ...
              <div className="flex flex-col gap-8">
                <div className="flex items-center gap-4 border-l-2 border-accent-gold pl-6">
                  <p className="text-[10px] font-bold text-ruah-950 uppercase tracking-[0.2em] italic">
                    &quot;A música ? a oração que não precisa de palavras para ser sentida.&quot;
                  </p>
                </div>

                <div className="flex gap-4">
                  {['Spotify', 'Apple Music', 'Deezer'].map((plat) => (
                    <button key={plat} className="px-6 py-3 bg-white border border-ruah-100 rounded-xl text-[8px] font-bold uppercase tracking-widest hover:border-accent-gold transition-colors">
                      {plat}
                    </button>
                  ))}
                </div>
