...
export function StickyMobileBar({ price }: StickyMobileBarProps) {
  const handlePrimaryAction = () => {
    const buyNowButton = document.getElementById('buy-now') as HTMLButtonElement | null;
    if (buyNowButton) {
      buyNowButton.click();
      return;
    }
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-sticky bg-white border-t border-ruah-100 p-4 lg:hidden flex items-center justify-between shadow-2xl">
