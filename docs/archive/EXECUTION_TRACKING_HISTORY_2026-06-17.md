...
- mencoes historicas a `/admin/support`, `/admin/production`, `/admin/finance/payouts` e `/finance/dashboard` nas entradas abaixo sao evidencia de contexto e nao descrevem o runtime canonico atual;
- a verdade vigente de rotas, guards e jornadas por papel deve ser lida em `docs/ROUTES.md`, `docs/WORKFLOW_RBAC_ACCESS_MATRIX.md`, `docs/USER_360_ROLE_ALIGNMENT.md` e `docs/JOURNEY_MATRIX_BY_ROLE.md`.
