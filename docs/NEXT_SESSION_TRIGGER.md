...
- `qa:community:revenue`: `NEXT_CANDIDATE`; requer analise de acoplamento e isolamento proprio antes de qualquer execucao.
...
- Proximo gate candidato: `npm run qa:community:revenue`, por ser o proximo recorte de campanha restante antes de `qa:base:roles`; ele nao pode ser executado ate uma analise propria separar e isolar pedido, checkout, pagamento, webhook, referral e atribuicao.
